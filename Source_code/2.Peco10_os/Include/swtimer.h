...
#define TM_DELAY_TIM_IRQ_HANDLER      TIM2_Callback

#define SOFTWARE_TIMER_AUTO_RELOAD_ENABLE              1U
#define SOFTWARE_TIMER_AUTO_RELOAD_DISABLE             0U
#define SOFTWARE_TIMER_START_TIMER_ENABLE              1U
#define SOFTWARE_TIMER_START_TIMER_DISABLE             0U
/**
...
TM_DELAY_Timer_t* TM_DELAY_TimerCreate(uint32_t ReloadValue, 
                                       uint8_t AutoReload, 
                                       uint8_t StartTimer, 
                                       void (*TM_DELAY_CustomTimerCallback)(void *), 
                                       void* UserParameters);
...
/*This should be called from a TIM interrupt handler*/
